...
class IPTVFastChecker:
    def __init__(self):
        ...
        # Кэш для уже проверенных доменов
        self.domain_cache = {}
    ...
    def read_required_channels(self):
        """Читает список каналов из spisok.m3u"""
        try:
            ...
            with open(self.spisok_file, 'r', encoding='utf-8', errors='ignore') as f:
                ...
                # Ищем названия каналов в формате M3U
                ...
                if matches:
                    ...
                    # Если это простой список (по одной строке)
    ...
    async def extract_urls_from_file(self, file_path):
        ...
        urls = []
        try:
            # Пропускаем файл spisok.m3u, чтобы не брать ссылки из него
            ...
            for url in found_urls:
                name = "Unknown"
                # Ищем название в ближайших строках
    ...
    async def quick_check(self, url):
        """Максимально быстрая проверка ссылки"""
        try:
            # Проверяем домен в кэше
            ...
            # Только HEAD запрос, очень быстрый
    ...
    def match_channels(self, required_channels):
        """Сопоставляет найденные ссылки с нужными каналами"""
    ...
    async def run(self):
        ...
        # 1. Читаем список нужных каналов из spisok.m3u
        ...
        # 2. Собираем все ссылки (пропуская spisok.m3u)
        ...
        # 4. Сопоставляем с нужными каналами
